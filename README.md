...
~AS A USER~ 
I want an app that is interactive and easy to use with simple instructions on how to play guitar chords. When I open the webpage I would like to be presented with options to select which chord I would like to learn. I would also like to be presented with a diagram of the chord so that I can visually see it and do it on my own. I would also like to hear the chord out loud so that I can compare my own playing to the tone coming from the application so that I know I am playing the chord correctly. As a beginner I may not know where to even start.. So for this reason I would like if there was an instructional page that teaches me the basics of finger placement and how to read a diagram. 


Technologies used:
HTML, CSS, JavaScript, JQuery, Bulma, Uberchord API, Scales and Chords API. 
